...
function create(data){
    ...
    <td><button class="btn" onclick="del('${data._id}')">Delete</button></td>
    <td><button class="btn" onclick="edit('${data._id}','${data.amount}','${data.date}','${data.reason}','${data.category}')">Edit</button></td></tr>`;
